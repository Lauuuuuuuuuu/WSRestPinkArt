...
public class ServicioObras {
    ...
    public ObrasArte crearObra(String titulo, int precio, File rutaImag, String path,boolean append) throws IOException {
        ...
        return new ObrasArte(titulo,precio,rutaImag);
    }
